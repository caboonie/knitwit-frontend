...
var _createCallbackMemoizer = require('./utils/createCallbackMemoizer.js');
...
var _updateScrollIndexHelper = require('./utils/updateScrollIndexHelper.js');
...
var Grid = function (_React$PureComponent) {
  ...
  (0, _createClass3.default)(Grid, [{
    ...
    value: function render() {
      ...
      var totalColumnsWidth = instanceProps.columnSizeAndPositionManager.getTotalSize()+25;
      var totalRowsHeight = instanceProps.rowSizeAndPositionManager.getTotalSize()+25;
    ...
    value: function _calculateChildrenToRender() {
      ...
      if (height > 0 && width > 0) {
        ...
        this._childrenToDisplay = cellRangeRenderer({
          staticCellCache: props.staticCellCache,
